...
const mobileLendingManagement: CaseStudy = {
  ...
  cardImpactLine:
    'It was easier to call and pay than it was to use the app.',
  ...
  cardDescription: 'Senior UX Designer upgrading a legacy loan app under tight dev constraints, moving borrowers from support calls to self-service.',
